...
def LoopingWorker(df_g, df_chia):
    df_chia.columns = ['CHR', 'Start','End', 'File_Name', 'Code', 'Annotation_En']
    ...
    for chrom in chrom_list:
        ...
        print('The number of Enhancers at the chrom {0} is {1}'.format(chrom, len(df_g_chrom)))
...
if __name__ == '__main__':
    ...
    SaveDFtoCSV('Results','Gene_Annotated_Chia_List1.csv', final_df1)
    ...
    SaveDFtoCSV('Results','Gene_Annotated_Chia_List2.csv', final_df2)
