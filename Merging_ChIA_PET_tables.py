...
if __name__ == '__main__':
    ...
    df_final.to_csv('Chia_Pet_Annotated.csv',sep =',', index = False)
    df_en_pro.to_csv('Chia_Pet_Annotated_en_pro.csv',sep =',', index = False)
    df_pro_pro.to_csv('Chia_Pet_Annotated_pro_pro.csv',sep =',', index = False)
    df_en_en.to_csv('Chia_Pet_Annotated_en_en.csv',sep =',', index = False)
    ...
    df_en_pro_rearranged.to_csv('Chia_Pet_Annotated_en_pro_small.csv',sep =',', index = False)
    '''
    #DECONVOLVE
    print('Analysing....')
    ...
    df_decov_f.to_csv('Chia_Pet_Annotated_Deconvolved.csv',sep =',', index = False)
    ...
    df_c.to_csv('Chia_Pet_Annotated_Deconvolved_allign.csv',sep =',', index = False)
    ...
    df_f2_f.to_csv('Chia_Pet_Annotated_Promoters_Enhancers_Significant.csv',sep =',', index = False)
    df_c_prom.to_csv('Chia_Pet_Annotated_Deconvolved_Promoters.csv',sep =',', index = False)
    df_c_prom_en.to_csv('Chia_Pet_Annotated_Deconvolved_Promoters_Enhancers.csv',sep =',', index = False)
    print('End')
