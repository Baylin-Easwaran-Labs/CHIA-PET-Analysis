...
######################################################################
def SuperEnhancerInput():
    
    folder1 = 'Super_Enhancers'
    filename = 'MCF-7.csv'
...
if __name__ == '__main__':
    ...
    SaveDFtoCSV('Results_Supper_Enhancers','Annotated_Chia_List1.csv', final_df1)
    ...
    SaveDFtoCSV('Results_Supper_Enhancers','Annotated_Chia_List2.csv', final_df2)
